    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('like_comment', models.CharField(choices=[('奥斯卡', '奥斯卡'), ('戛纳', '戛纳'), ('金鸡', '金鸡'), ('None', 'None')], default=None, max_length=32, verbose_name='获奖')),
            ],
            options={
                'verbose_name': '电影',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(auto_now_add=True)),
                ('like_comment', models.IntegerField(default=0, verbose_name='点赞')),
