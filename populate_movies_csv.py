...
for line in lines[1:]:
    ...
    pic_name = 'movie_cover/' + name.replace('/', '_')+'.png'
    movie = Movie.objects.create(name=name, pic=pic_name, country=country, years=years, leader=leader, d_rate_nums=int_d_rate_num, d_rate=star, intro=description, director=director_description)
